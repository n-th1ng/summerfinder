...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-2xl': ['clamp(1.75rem, 2.5vw + 1rem, 4rem)', { lineHeight: '1.04', letterSpacing: '-0.035em', fontWeight: '800' }],
        'display-xl': ['clamp(1.625rem, 2vw + 0.875rem, 3.25rem)', { lineHeight: '1.06', letterSpacing: '-0.03em', fontWeight: '800' }],
        'display-lg': ['clamp(1.5rem, 1.5vw + 0.75rem, 2.5rem)', { lineHeight: '1.1', letterSpacing: '-0.025em', fontWeight: '700' }],
        'display-md': ['clamp(1.25rem, 1vw + 0.625rem, 1.875rem)', { lineHeight: '1.18', letterSpacing: '-0.02em', fontWeight: '700' }],
        'display-sm': ['clamp(1.0625rem, 0.5vw + 0.875rem, 1.25rem)', { lineHeight: '1.25', letterSpacing: '-0.01em', fontWeight: '600' }],
      },
      borderRadius: {
        '4xl': '2rem',
        '5xl': '2.5rem',
