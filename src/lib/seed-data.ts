// Static activity catalog — used as the seed data and as a fallback
// when the database is unreachable. Identical structure to the Prisma
// Activity model so a runtime swap is transparent.
